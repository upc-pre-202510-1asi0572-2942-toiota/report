...
|Epic 013|Recolección de datos fisiológicos desde el parche|**Como usuario, quiero que el parche registre automáticamente datos como glucosa, temperatura y ritmo cardíaco, para monitorear continuamente la salud del paciente y facilitar su seguimiento clínico.**|**-**|US33, US34, US35 y US36.|
|Epic 014|Cálculo automático de la dosis de insulina|**Como usuario, quiero que el parche calcule automáticamente la dosis de insulina con base en parámetros clínicos, para evitar errores y asegurar un tratamiento más preciso.**|**-**|US33, US34, US35 y US36.|
|Epic 015|Administración automática de insulina|**Como usuario, quiero que el parche administre insulina de forma automática, registrando cada evento y permitiendo control previo del paciente, para mantener la glucosa estable y segura.**|**-**|US33, US34, US35 y US36.|
|Epic 016|Conectividad entre dispositivos|**Como usuario, quiero que los datos del parche se sincronicen automáticamente con la app móvil y servidores, para tener acceso en tiempo real desde cualquier lugar.**|**-**|US33, US34, US35 y US36.|
|Epic 017|Alertas y control desde la app|**Como usuario, quiero recibir alertas y poder configurar o desactivar el autosuministro desde la app, para actuar con rapidez y adaptar el tratamiento a cada situación.**|**-**|US33, US34, US35 y US36.|
|Epic 018|Seguridad y privacidad de los datos|**Como usuario, quiero que los datos estén protegidos y solo accesibles por usuarios autorizados, para garantizar la privacidad y el cumplimiento de normativas.**|**-**|US33, US34, US35 y US36.|
